class Memorama
{
    ...
    seleccionDificultad()
    {
        const mensaje = prompt('Seleccione el nivel de dificultad: fácil, intermedio ó difícil. Si no selecciona ningún nivel por defecto el nivel será intermedio.');
